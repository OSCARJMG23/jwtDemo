...
{
public static async Task SeedAsync(ApiDemoContext context, ILoggerFactory loggerFactory)
    {
        try
        {
        ...
        {
            var logger = loggerFactory.CreateLogger<ApiDemoContext>();
            logger.LogError(ex.Message);
        }
    }

    public static async Task SeedRolesAsync(ApiDemoContext context, ILoggerFactory loggerFactory)
    {
        try
        {
            if (!context.Rols.Any())
